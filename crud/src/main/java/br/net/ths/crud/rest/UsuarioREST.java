...
import br.net.ths.crud.model.Login;
import br.net.ths.crud.model.Usuario;
...
public class UsuarioREST{
    ...
    public ResponseEntity<Usuario> inserir(@RequestBody Usuario usuario){
        Usuario u = lista.stream().filter(
            usu->usu.getLogin().equals(usuario.getLogin()))
            .findAny().orElse(null);
   ...
   public ResponseEntity<Usuario> login (@RequestBody Login login){
    ...
    static {
        ...
        lista.add(
            new Usuario(3, "function", "func", "func", "FUNC"));
